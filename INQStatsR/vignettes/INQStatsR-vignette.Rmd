...
databycountry() connects you and provides you with a data frame of the requested input from INQStats API. 

### Request
databycountry() require 4 parameters for running the function. 
...
2. **country_code** = a selection of what countries to extract from the API. Select a country by stating it's *ISO 3166-1* code in a string. If you want to select several countries at once, add the countries as to the string and separate by comma (,) **without** spaces.
